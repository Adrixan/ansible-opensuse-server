...
## Compact Semantic Role Architecture (18 Roles)
...
14. **[multimedia_codecs](file:///home/Adrixan/code/ansible-opensuse-server/roles/multimedia_codecs)**: Packman media players & codecs (`vlc`, `ffmpeg`, `mpv`, `gstreamer`, `x264`, `x265`).
...
17. **[gaming_environment](file:///home/Adrixan/code/ansible-opensuse-server/roles/gaming_environment)**: Steam, Steamtricks, Lutris, GameHub, DOSBox, GZDoom, Doomsday.
